 ...
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\PlayUserOrderController();
 * )
 */
...
class PlayUserOrderController extends BaseController
{
    ...
    public function index()
    {
        ...
        //查询条件
        $where = [];
        if ($params["keyword"]) $where[] = ["user_id|order_num|status", "like", "%{$params["keyword"]}%"];
        ...
        //查询数据
        $result = $PlayUserOrderInit->get_list_paginate($where, $params);
    ...
    public function edit()
    {
        ...
        //查询数据
        $params["InterfaceType"] = "admin";//接口类型
        $result                  = $PlayUserOrderInit->get_find($where, $params);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $PlayUserOrderInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $PlayUserOrderInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $PlayUserOrderInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $PlayUserOrderInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $PlayUserOrderInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $PlayUserOrderInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $PlayUserOrderInit->get_list($where, $params);
