 ...
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\DrawController();
 * )
 */
...
class DrawController extends BaseController
{
    ...
    public function index()
    {
        ...
        /** 查询数据 **/
        $result = $DrawInit->get_list_paginate($where, $params);
    ...
    public function add_post()
    {
        ...
        /** 检测参数信息 **/
        $validateResult = $this->validate($params, 'Draw');
        if ($validateResult !== true) $this->error($validateResult);


        /** 插入数据 **/
        $result = $DrawInit->admin_edit_post($params);
    ...
    public function edit_post()
    {
        ...
        /** 提交数据 **/
        $result = $DrawInit->admin_edit_post($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function edit_post_two()
    {
        ...
        /** 提交数据 **/
        $result = $DrawInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        /** 删除数据 **/
        $result = $DrawInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $DrawInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $DrawInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
