 ...
 *     "controller_name"     =>"PlayPackageSku",
 ...
 *     "remark"              =>"规格管理",
 *     "author"              =>"",
 *     "create_time"         =>"2024-04-15 10:18:06",
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\PlayPackageSkuController();
 * )
 */
...
class PlayPackageSkuController extends BaseController
{
    ...
    {
        $PlayPackageSkuInit  = new \init\PlayPackageSkuInit();//规格管理    (ps:InitController)
        $PlayPackageSkuModel = new \initmodel\PlayPackageSkuModel(); //规格管理   (ps:InitModel)
        $params              = $this->request->param();
        ...
        //查询数据
        $result = $PlayPackageSkuInit->get_list_paginate($where, $params);
    ...
    public function edit()
    {
        ...
        //查询数据
        $params["InterfaceType"] = "admin";//接口类型
        $result                  = $PlayPackageSkuInit->get_find($where, $params);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $PlayPackageSkuInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $PlayPackageSkuInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $PlayPackageSkuInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $PlayPackageSkuInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $PlayPackageSkuInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $PlayPackageSkuInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $PlayPackageSkuInit->get_list($where, $params);
